...
import CarCheckOutPage from "./CarCheckOutPage";
...
const CarDetails = ({ isOpen, closeModal, car }: CarDetailProp) => {
        ...
        <>
            <Transition appear show={isOpen} as={Fragment}>
                <Dialog as="div" onClose={closeModal} className="relative z-10">
                    ...
                    <CarCheckOutPage isChOpen={isChOpen} closeModal={() => setIsChOpen(false)} car={car} />
                </Dialog>
            </Transition>
        </>
    );
